    ...
    >
      ...
      <div className="grid grid-cols-3 gap-[9px] mb-3">
        <div className="bg-paper rounded-[15px] p-[11px_10px] text-center" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
          <p className="m-0 mb-0.5 text-[10px] font-bold uppercase" style={{ letterSpacing: '0.08em', color: '#C75A31' }}>
            Open
          </p>
          <p className="m-0 font-serif text-lg text-navy">{boardOpenN}</p>
        </div>
        <div className="bg-paper rounded-[15px] p-[11px_10px] text-center" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
          <p className="m-0 mb-0.5 text-[10px] font-bold uppercase" style={{ letterSpacing: '0.08em', color: '#8A8375' }}>
            Quorum
          </p>
          ...
          <div className="flex flex-col gap-2.5 mb-[22px]">
            ...
            <div className="bg-paper rounded-[18px] p-[15px_16px]" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
              <div className="flex items-center gap-3">
                ...
                {state.reportTicketed && (
                  <span className="text-[11.5px] font-bold flex-shrink-0 text-right" style={{ color: '#2A9D5C' }}>
                    #M-88 ✓
                    <br />
                    BrightPath Electric
                  </span>
        ...
        <div className="animate-fadeup">
          ...
          <div className="bg-paper rounded-[18px] px-4 mb-5" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            ...
            {state.arcApprovedByBoard && (
              <div className="flex items-center gap-[11px] py-[11px]" style={{ borderBottom: '1px solid rgba(26,51,82,0.07)' }}>
                ...
                <span className="rounded-full px-[9px] py-[3px] text-[10.5px] font-bold" style={{ background: '#E9F6EE', color: '#228049' }}>
                  Approved today
                </span>
              </div>
            )}
          ...
          <div className="bg-paper rounded-[18px] px-4 mb-5" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            {state.reportSubmitted && (
              <div className="flex items-center gap-[11px] py-[11px]" style={{ borderBottom: '1px solid rgba(26,51,82,0.07)' }}>
                ...
                {state.m89Assigned && (
                  <span className="text-[11px] font-bold flex-shrink-0" style={{ color: '#2A9D5C' }}>
                    GreenScape ✓
                  </span>
                )}
              </div>
          ...
          <div className="bg-paper rounded-[18px] p-4" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            <div className="flex items-center gap-[11px] pb-3 mb-3" style={{ borderBottom: '1px solid rgba(26,51,82,0.07)' }}>
              ...
              <span className="rounded-full px-[9px] py-[3px] text-[10.5px] font-bold flex-shrink-0" style={{ background: '#FBF3E0', color: '#A87B1F' }}>
                No fee
              </span>
            </div>
            <p className="m-0 text-xs font-semibold text-stone">
          ...
          <p className="mt-5 mb-2.5 text-[11px] font-bold uppercase" style={{ letterSpacing: '0.12em', color: '#8A8375' }}>
            Vendors
          </p>
        ...
        <div className="animate-fadeup">
          ...
          <div className="bg-paper rounded-[20px] p-4 mb-[22px]" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            <div className="flex items-center gap-[11px] pb-2.5 mb-2.5" style={{ borderBottom: '1px solid rgba(26,51,82,0.07)' }}>
              ...
              <span className="text-[12.5px] font-bold" style={{ color: '#C75A31' }}>
                $570
              </span>
            </div>
            <div className="flex items-center gap-[11px] pb-2.5 mb-2.5" style={{ borderBottom: '1px solid rgba(26,51,82,0.07)' }}>
          ...
          <div className="bg-paper rounded-[20px] p-4 mb-[22px]" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            ...
            <div>
              <div className="flex justify-between mb-[5px]">
                ...
                <span className="text-[11.5px] font-bold" style={{ color: '#A87B1F' }}>
                  61% of $31.2K · watch
                </span>
              </div>
      ...
      {state.boardTab === 'comms' && (
        <div className="animate-fadeup">
          ...
          <p className="mt-[22px] mb-2.5 text-[11px] font-bold uppercase" style={{ letterSpacing: '0.12em', color: '#8A8375' }}>
            Put it to a vote
          </p>
          <div className="bg-paper rounded-[20px] p-4 mb-[22px]" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            {!state.votePosted && (
                ...
                {state.voteDraftOpen && (
                  <div className="animate-fadeup">
                    ...
                    <div className="rounded-xl px-[13px] py-[11px] mb-3" style={{ background: '#F9F5EC' }}>
                      <p className="m-0 mb-[5px] text-[10.5px] font-bold uppercase" style={{ letterSpacing: '0.08em', color: '#8A8375' }}>
                        Residents will see
                      </p>
          ...
          <div className="bg-paper rounded-[20px] p-4 mb-[22px]" style={{ border: '1px solid rgba(26,51,82,0.08)' }}>
            ...
            <div className="rounded-[11px] px-3 py-2.5 flex items-center gap-2.5 mb-3" style={{ background: '#FBF3E0' }}>
              ...
              <span className="text-xs font-bold" style={{ color: '#A87B1F' }}>
