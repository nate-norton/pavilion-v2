    ...
    >
      ...
      <div className="grid grid-cols-3 gap-[9px] mb-4">
        ...
        <div className="bg-paper rounded-[15px] p-[13px_10px] text-center" style={{ border: '1px solid rgb(var(--navy) / 0.08)' }}>
          ...
          <p className="m-0 text-[9.5px] font-bold" style={{ color: 'rgb(var(--stone))', letterSpacing: '0.05em' }}>
            OPEN ITEMS
          </p>
        </div>
        <div className="bg-paper rounded-[15px] p-[13px_10px] text-center" style={{ border: '1px solid rgb(var(--navy) / 0.08)' }}>
            ...
            >
              ...
              <div className="flex items-center gap-2.5">
                <div className="flex-1">
                  <ProgressBar pct={c.collected} height={8} color={c.tone} track="rgb(var(--sand))" />
                </div>
