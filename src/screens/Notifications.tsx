...
export function Notifications() {
  ...
  const renderRow = (nt: Notif) => (
    ...
    >
      ...
      {nt.unread && !state.notifsRead && (
        <span data-testid="notif-dot" className="w-[9px] h-[9px] rounded-full flex-shrink-0" style={{ background: 'rgb(var(--sunset))' }} />
      )}
  ...
  return (
    ...
    >
      ...
      {today.length > 0 && (
        <div>
          <p className="m-0 mb-[9px] text-[11px] font-bold uppercase" style={{ letterSpacing: '0.12em', color: 'rgb(var(--slate))' }}>
            Today
          </p>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: muted ? 'rgb(var(--slate))' : 'rgb(var(--sagedark))',
                  padding: '8px 13px',
                }}
              >
