...
const PIECES: ConfettiPiece[] = [
  { width: 7, height: 11, background: 'rgb(var(--sunset))', tx: '-84px', ty: '-72px', rot: '220deg', delay: '0.05s', duration: '0.9s' },
  ...
  { width: 6, height: 10, background: 'rgb(var(--sunsetbright))', tx: '-40px', ty: '-100px', rot: '180deg', delay: '0s', duration: '1s' },
];
