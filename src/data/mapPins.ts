...
export const PINS: Pin[] = [
  ...
  { key: 'gate', x: '24%', y: '52%', icon: 'ph-fill ph-warning', color: 'rgb(var(--gold))', layer: 'alerts', title: 'Pool gate repair · Thu AM', sub: 'Brief closure while AquaFix visits', action: 'Details', go: 'reserve' },
  { key: 'new', x: '30%', y: '76%', icon: 'ph-fill ph-hand-waving', color: 'rgb(var(--gold))', layer: 'events', title: 'The Okafors · #42', sub: 'Moved in this week — say hi', action: 'Say hi', go: 'chat-okafor' },
];
