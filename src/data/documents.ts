...
export const DOC_SECTIONS: DocSection[] = [
  { tag: '§4', name: 'Exteriors', accent: 'rgb(var(--accent))', kw: 'exterior arc paint fence color palette cedar sage clay structure', body: 'ex' },
  { tag: '§5', name: 'Living', accent: 'rgb(var(--slate))', kw: 'quiet hours hens chickens roosters coop fireworks noise pets', body: 'liv' },
  { tag: '§7', name: 'Leasing', accent: 'rgb(var(--slate))', kw: 'lease rent tenant register short-term term months', body: 'lease' },
  { tag: '§9', name: 'Assessments', accent: 'rgb(var(--slate))', kw: 'dues assessment fee late reserve courtesy payment', body: 'assess' },
];
