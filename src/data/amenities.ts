...
export const AMENS: Amenity[] = [
  ...
  { name: 'Clubhouse', sub: 'Up to 40 · events & parties', icon: 'ph-fill ph-buildings', avail: '2 slots today', taken: [0, 1, 2, 5], occ: 'Empty until 5 PM', occColor: 'rgb(var(--slatelight))', rules: '$100 refundable deposit for private events · cleaned & locked by 10 PM' },
