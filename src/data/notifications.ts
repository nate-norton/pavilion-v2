...
export const NOTIFS: Notif[] = [
  { key: 'vote', icon: 'ph-fill ph-check-square', color: 'rgb(var(--terracotta))', bg: 'rgb(var(--blush))', title: 'Pool furniture vote closes Thursday', sub: '2h ago', cat: 'HOA', when: 'today', go: 'hoa', unread: true },
  { key: 'taco', icon: 'ph-fill ph-storefront', color: 'rgb(var(--ember))', bg: 'rgb(var(--blush))', title: 'Taco cart tonight — 12 neighbors going', sub: '4h ago', cat: 'Events', when: 'today', go: 'events', unread: true },
  ...
  { key: 'digest', icon: 'ph-fill ph-newspaper', color: 'rgb(var(--stone))', bg: 'rgb(var(--sand))', title: 'Your June digest: 4 decisions, 6 events', sub: 'Jun 30', cat: 'Digest', when: 'earlier', go: 'hoa', unread: false },
